              ...
              <div id="accordion1" class="according">
                <div class="card">
                  <div class="card-header">
                      <a class="card-link" data-toggle="collapse" href="#accordion11">Informacion Personal</a>
                  </div>
                  <div id="accordion11" class="collapse show" data-parent="#accordion1">
                    <div class="card-body">
                       <div class="form-row align-items-center">
                         ...
                         <div class="col-sm-4 my-1">
                             <label for="apellidoPaterno" class="col-form-label">Segundo Apellido</label>
                ...
                <div class="card">
                    <div class="card-header">
                        <a class="collapsed card-link" data-toggle="collapse" href="#accordion12">Informacion de contacto</a>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <a class="card-link" data-toggle="collapse" href="#accordion13">Informacion Laboral</a>
                    </div>
                        ...
                        <div class="card-body">
                               ...
                               <div class="col-sm-2  my-1 ">
                                 <label class="col-form-label">Tipo de medio</label>
                                  <select class="custom-select col-sm-11" name="tipodemedio" id="tipodemedio">
                                    <option selected="selected" value="0">Seleccione un valor</option>
                                     <?php foreach($tipodemedio as $medio):?>
                                     <option value="<?php echo $medio->id;?>" <?php echo $medio->id==$trabajo->id_tipodemedio ? "selected":"";?> ><?php echo $medio->nombre;?></option>
                                     <?php endforeach;?>
                                  </select>
                                </div>
                                <div class="col-sm-3 my-1 ">
                                ...
                                <div class="col-sm-2  my-1 ">
                                 ...
                                 <div class="col-sm-5 my-1 ">
                                     ...
                                     <input class="form-control form-control-sm input-rounded col-sm-11" type="text" value="<?php echo $trabajo->DireccionDelMedio;?>" id="direcciondelmedio" name="direcciondelmedio">
                                 </div>
                            </div>
                            <div class="form-row align-items-center">
                              <div class="col-sm-2  my-1 ">
                            ...
                            <div class="form-row align-items-center">
                              ...
                              <div class="col-sm-4 my-1 ">
                                  ...
                                  <select class="custom-select col-sm-10" name="sexodeljefeinmediato" id="sexodeljefeinmediato">
                                  <option selected="selected" value="0">Seleccione un valor</option>
                              ...
                              <div class="col-sm-4 my-1 ">
                                  ...
                                  <input class="form-control form-control-sm input-rounded col-sm-11" type="number" value="<?php echo $trabajo->cuantasreporterasyreporteroshayenelmedio;?>" id="cuantasreporterasyreporteroshayenelmedio" name="cuantasreporterasyreporteroshayenelmedio">
                              </div>
                            </div>
                            <div class="form-row align-items-center">
                              <div class="col-sm-4 my-1 ">
                                  <label for="cuantasreporterashayenelmedio" class="col-form-label">¿Cuantas reporteras hay en el medio?</label>
                                  <input class="form-control form-control-sm input-rounded col-sm-10" type="number" value="<?php echo $trabajo->cuantasreporterashayenelmedio;?>" id="cuantasreporterashayenelmedio" name="cuantasreporterashayenelmedio">
                              </div>
                              <div class="col-sm-4 my-1 ">
                                  ...
                                  <input class="form-control form-control-sm input-rounded col-sm-11" type="number" value="<?php echo $trabajo->cuantasreporterasyreporteroshayenlafuente;?>" id="cuantasreporterasyreporteroshayenlafuente" name="cuantasreporterasyreporteroshayenlafuente">
                              </div>
                              <div class="col-sm-4 my-1 ">
                                  <label for="cuantasreporterashayenlafuente" class="col-form-label">¿Cuantas reporteras hay en la fuente?</label>
                                  <input class="form-control form-control-sm input-rounded col-sm-11" type="number" value="<?php echo $trabajo->cuantasreporterashayenlafuente;?>" id="cuantasreporterashayenlafuente" name="cuantasreporterashayenlafuente">
                              </div>
                            </div>
                        </div>
                    </div>

                                            ...
                                            <div class="card-body">
                                                <div class="form-row align-items-center">
                                                   <div class="col-sm-2  my-1 ">
                                                    ...
                                                    <div class="col-sm-3 my-1 ">
                                                        ...
                                                        <input class="form-control form-control-sm input-rounded col-sm-8" type="number" value="" id="paracuantosmedioslabora" name="paracuantosmedioslabora">
                                                    </div>
                                                    <div class="col-sm-2 my-1 ">
                                                ...
                                                <div class="form-row align-items-center">
                                                    <div class="col-sm-4 my-1 ">
                                                        ...
                                                        <input class="form-control form-control-sm input-rounded col-sm-6" type="number" value="" id="AnosDeEjercerElPeriodismo" name="AnosDeEjercerElPeriodismo">
                                                    </div>
                                                    <div class="col-sm-2 my-1 ">

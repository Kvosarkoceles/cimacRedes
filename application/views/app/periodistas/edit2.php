                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="accordion1" class="according">
                                                ...
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-sm-4 my-1 ">
                                                         <label for="telefonocelular" class="col-form-label">Telefono Celular</label>
                                                          <input class="form-control form-control-sm input-rounded col-sm-8" type="tel" value="<?php echo $periodista->apellidoMaterno;?>" id="telefonocelular" name="telefonocelular">
                                                    </div>
                                                    <div class="col-sm-4 my-1 ">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <a class="collapsed card-link" data-toggle="collapse" href="#accordion13">Informacion Laboral</a>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="form-row align-items-center">
                                                   <div class="col-sm-2  my-1 ">
                                                        ...
                                                        <select class="custom-select col-sm-9" name="tipodemedio" id="tipodemedio">
                                                        <option selected="selected" value="0">Seleccione un valor</option>
                                                    ...
                                                    <div class="col-sm-3 my-1 ">
                                                        ...
                                                        <input class="form-control form-control-sm input-rounded col-sm-8" type="number" value="<?php echo $trabajo->paracuantosmedioslabora;?>" id="paracuantosmedioslabora" name="paracuantosmedioslabora">
                                                    </div>
                                                    <div class="col-sm-2 my-1 ">
                                                        <label class="col-form-label">Tipo de contrato</label>
                                                        <select class="custom-select col-sm-9" name="tipodecontrato" id="tipodecontrato">
                                                        <option selected="selected" value="0">Seleccione un valor</option>
                                                ...
                                                <div class="form-row align-items-center">
                                                    <div class="col-sm-4 my-1 ">
                                                        ...
                                                        <input class="form-control form-control-sm input-rounded col-sm-6" type="number" value="<?php echo $trabajo->AnosDeEjercerElPeriodismo;?>" id="AnosDeEjercerElPeriodismo" name="AnosDeEjercerElPeriodismo">
                                                    </div> 
                                                    <div class="col-sm-2 my-1 ">
                                                        <label class="col-form-label">Sexo del jefe inmediato</label>
                                                        <select class="custom-select col-sm-9" name="sexodeljefeinmediato" id="sexodeljefeinmediato">
                                                        <option selected="selected" value="0">Seleccione un valor</option>
                                ...
                                <button type="submit" class="btn btn-outline-primary btn-flat float-right">Guardar</button>
                        </div>
                                </div>
                            </div>
                        </div>
